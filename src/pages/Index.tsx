  ...
  <div className="bg-background min-h-screen">
    ...
    <div className="flex flex-col gap-12 items-center justify-center max-w-2xl mx-auto py-12 px-4 animate-fade-in">
      <div className="text-center">
        <h1 className="text-5xl md:text-6xl font-extrabold mb-4 tracking-tight">Spotify-like Audio Stories</h1>
        <p className="text-xl text-muted-foreground mb-4">
          Listen to and upload audio stories! <br/>Sign in to contribute your own, or browse the latest stories.
        </p>
        <Button asChild>
